...
namespace AssetBundles
{
    public class AssetBundleConfig
    {
        ...
        public const string EncryptFolderName = "Encrypt";
        ...
        public const string AssetsPathMapFileName = "Text/AssetsMap.bytes";
        public const string VariantsMapFileName = "Text/VariantsMap.bytes";
        public const string LanguageFileName = "Text/Language.json";
