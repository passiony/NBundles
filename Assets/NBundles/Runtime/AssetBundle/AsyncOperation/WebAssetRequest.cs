    ...
    public class WebAssetRequester : BaseAssetRequester
    {
        ...
        public string error
        {
            get
            {
                ...
                return string.IsNullOrEmpty(_www.error) ? null : _www.error;
            }
        }
        ...
        public override float Progress()
        {
            ...
            return _www != null ? _www.progress : 0f;
        }
        ...
        public override void Update()
        {
            ...
            isOver = _www != null && (_www.isDone || !string.IsNullOrEmpty(_www.error));
            if (!isOver)
            {
                return;
            }
